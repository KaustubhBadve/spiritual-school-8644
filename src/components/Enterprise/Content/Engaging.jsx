      ...
      <div className="content_container" style={{ backgroundColor: "#24282f" }}>
        <div>
          ...
          <div className="content_p" style={{ color: "white" }}>
            Lumen5 is the easiest and <br/> fastest way to create videos<br/>with your own
            custom branded<br/> templates. Decentralize video <br/>creation on your teams
            with <br/> confidence.
          </div>
        ...
        <div className="content_v">
          ...
          />
          <div className="icon-circle" onClick={onOpen} style={{top:"42%",left:"25%"}}>
            <i
