    ...
    <div className="explore-container">
      <div className="explore-sub-container">
        ...
        <div className="explore-btn">
          <button onClick={handleMarketing}>Content Marketing</button>
          <button onClick={handleCommunication}>Communications</button>
          <button onClick={handlePromotion}>Promotional</button>
          <button onClick={handlePeople}>People & Culture</button>
          <button onClick={handleLocal}>Localization</button>
        </div>
        {local&&<div className="explore-template">
          <div>
        ...
        {people && <div className="explore-template">
          <div>
            <LandingSampleTemplate
              className="video-sub"
              imgp={
        ...
        {promotion&&<div className="explore-template">
          <div>
            <LandingSampleTemplate
              className="video-sub"
              imgp={
        ...
        {marketing&& <div className="explore-template">
          <div>
            <LandingSampleTemplate
              className="video-sub"
              imgp={
        ...
        {Communications&& <div className="explore-template">
          <div>
            <LandingSampleTemplate
              className="video-sub"
              imgp={
