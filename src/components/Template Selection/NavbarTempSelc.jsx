  ...
  return (
    <Box  display="flex" justifyContent="space-between" borderBottom="1px solid #dddee6" p="13px">
      <Stack direction="row"  alignItems="center">
        <Image cursor="pointer" onClick={()=> navigate("/selectTemplate")}  width="110px" src="https://storage.googleapis.com/lumen5-site-images/L5-logo/L5-logo-color-default.svg"/>
