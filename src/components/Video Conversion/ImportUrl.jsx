    ...
    <Box width="400px" border="1px solid #dddee6" borderLeft="none">
     <Box borderBottom="1px solid #dddee6" height="75px" >
        <Stack pt="20px" direction="row" alignItems="center">
            <span style={{fontSize:"18px"}}><i className="fa-solid fa-file-circle-plus"></i></span>
            <Input onChange={(e)=>setinpValue(e.target.value)} width="75%" placeholder="Paste a URL to your blog/article" variant='flushed'  />
            <Button _hover={{color:"black", backgroundColor:"#5846f6"}} backgroundColor="#5846f6" fontSize="14px"  color="white" borderRadius="30px" border="1px solid #5b4af6"  width="80px" pr="8px" onClick={HandleInport} pl="8px">IMPORT</Button> 
        </Stack>

        {boxChange ? <FilledBox/> : <EmptyBox/>}

        <Stack direction="row"> 
          <Box  border="1px solid #dddee6" fontSize="14px" pt="6px" color="gray" width="70%" height="40px" >
          Use A.I to generate a summary <span style={{marginLeft:"20px"}}><i className="fa-solid fa-angle-up"></i></span>
          </Box>
